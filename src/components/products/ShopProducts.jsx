...
const ShopProducts = ({styles}) => {
    return (
        ...
        'grid-cols-1 md-lg:grid-cols-2 md:grid-cols-2'} gap-3`}>
            {
                [1,2,3,4,5,6].map((p,i) => <div key={i} className={`flex transition-all duration-500 hover:shadow-md hover:-translate-y-3
                ...
                w-full gap-4 bg-white p-1 rounded-md`}>
                    ...
                    <div className='flex justify-start items-start flex-col gap-1'>
                            ...
                            <div className='flex justify-start items-center gap-3'>
                                <span className='text-lg font-semibold'>$657</span>
                                <div className='flex'>
                                    <Rating ratings={4.5}/>
                                </div>
                            </div>
