...
const Reviews = ({product}) => {
    ...
    const {reviews, rating_review, totalReview, successMessage}  = useSelector(state => state.home)
        ...
        <div className='mt-8'>
            <div className='flex gap-10 md-lg:flex-col'>
                <div className='flex flex-col gap-2 justify-start items-start py-4'>
                    ...
                    <div className='flex text-3xl'><Rating ratings={product.rating} /></div>
                ...
                <div className='flex gap-2 flex-col py-4'>
                    <div className='flex justify-start items-center gap-5'>
                        ...
                        <div className='w-[200px] h-[14px] bg-slate-200 relative'>
                            <div style={{width: `${Math.floor((100* (rating_review[0]?.sum || 0))/totalReview)}%`}} className='h-full bg-[#Edbb0e] w-[0%]'></div>
                        </div>
                    ...
                    <div className='flex justify-start items-center gap-5'>
                        ...
                        <div className='w-[200px] h-[14px] bg-slate-200 relative'>
                            <div style={{width: `${Math.floor((100* (rating_review[1]?.sum || 0))/totalReview)}%`}} className='h-full bg-[#Edbb0e] w-[0%]'></div>
                        </div>
                    ...
                    <div className='flex justify-start items-center gap-5'>
                        ...
                        <div className='w-[200px] h-[14px] bg-slate-200 relative'>
                            <div style={{width: `${Math.floor((100* (rating_review[2]?.sum || 0))/totalReview)}%`}} className='h-full bg-[#Edbb0e] w-[0%]'></div>
                        </div>
                    ...
                    <div className='flex justify-start items-center gap-5'>
                        ...
                        <div className='w-[200px] h-[14px] bg-slate-200 relative'>
                            <div style={{width: `${Math.floor((100* (rating_review[3]?.sum || 0))/totalReview)}%`}} className='h-full bg-[#Edbb0e] w-[0%]'></div>
                        </div>
                    ...
                    <div className='flex justify-start items-center gap-5'>
                        ...
                        <div className='w-[200px] h-[14px] bg-slate-200 relative'>
                            <div style={{width: `${Math.floor((100* (rating_review[4]?.sum || 0))/totalReview)}%`}} className='h-full bg-[#Edbb0e] w-[0%]'></div>
                        </div>
                    ...
                    <div className='flex justify-start items-center gap-5'>
                        ...
                        <div className='w-[200px] h-[14px] bg-slate-200 relative'>
                            <div style={{width: `${Math.floor((100* (rating_review[5]?.sum || 0))/totalReview)}%`}} className='h-full bg-[#Edbb0e] w-[0%]'></div>
                        </div>
            ...
            <div>
                {
                    userInfo ? <div className='flex flex-col gap-3'>
                        ...
                        <Link className='py-1 px-5 bg-red-500 text-white rounded-sm' to='/login'>Login First</Link>
                    </div>
                }
            </div>
        </div>
