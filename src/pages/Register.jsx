...
const Register = () => {
    ...
    return (
        <div>
            {
                loader && <div className='w-screen h-screen flex justify-center items-center fixed left-0 top-0 bg-[#38303033] z-[999]'><FadeLoader /></div> 
            }
            <Header />
            <section>
                    ...
                    <div className='w-full justify-center items-center p-10'>
                        <div className='grid grid-cols-2 w-[60%] mx-auto bg-white rounded-md'>
                            <div className='px-8 py-8'>
                                    ...
                                    <form onSubmit={register}>
                                        <div className='text-slate-600'>
                                            <div className='flex flex-col gap-1 mb-2'>
                                                ...
                                                <input onChange={inputHandle} value={state.name} className='w-full px-3 py-2 border border-slate-200 outline-none focus:border-[#852770] rounded-md' 
                                            ...
                                            <button className='px-8 w-full py-2 bg-[#852770] shadow-lg hover:shadow-[#852770]/40 text-white rounded-md'>Register</button>
                                        </div>
                                    </form>
                                ...
                                <a target='_blank' href="https://dashboard-lake-six-14.vercel.app/login">
                                ...
                                <a target='_blank' href="https://dashboard-lake-six-14.vercel.app/register">
                        ...
                        <div className='w-full h-full py-4 pr-4'>
                            <img className='w-full ' src="https://frontend-lilac-nine.vercel.app/images/login.jpg" alt="" />
                        </div>
                    </div>
                    </div>
                </div>
