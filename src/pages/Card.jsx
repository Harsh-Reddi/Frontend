...
const Card = () => {
    ...
    const {cart_products, price, successMessage, buy_product_item, outofstock_products, shipping_fee } = useSelector(state => state.cart)
    const redirect = () => {
        navigate('/shipping', {
            state: {
                                ...
                                <div className='pr-3 md-lg:pr-0'>
                                    <div className='flex flex-col gap-3'>
                                        <div className='bg-white p-4'>
                                            <h2 className='text-md text-[#852770] font-semibold'>Stock Products {cart_products[0].products.length}</h2>
                                        </div>
                                        {
                                ...
                                <div className='pl-3 md-lg:pl-0 md-lg:mt-5'>
                                    {
                                        cart_products.length > 0 && <div className='bg-white p-3 text-slate-600 flex flex-col gap-3'>
                                            ...
                                            <button onClick={redirect} className='px-5 py-[6px] rounded-sm hover:shadow-red-500/50 hover:shadow-lg bg-red-500 text-sm text-white uppercase'>Proceed To Checkout({buy_product_item})</button>
                                        </div>
                                    }
                                </div>
                            </div>
