...
const SearchProduct = () => {
    ...
    return (
        <div>
            <Header />
            <section className='bg-[url(https://frontend-lilac-nine.vercel.app/images/banner/shop.png")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'> 
            ...
            <section className='py-16'>
                <div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto '>
                    ...
                    <div className='w-full flex flex-wrap'>
                        <div className={`w-3/12 md-lg:w-4/12 md:w-full pr-8 ${filter ? 'md:h-0 md:overflow-hidden md:mb-6' : 
                        'md:h-auto md:overflow-auto md:mb-0'}`}>
                            ...
                            <div className='py-2 flex flex-col gap-5'>
                                ...
                                <Range
                                    ...
                                    renderThumb={({props}) => (
                                        <div className='w-[15px] h-[15px] bg-[#852770] rounded-full' {...props} />
                                    )}
                                />
                            </div>
                                ...
                                <div className='py-4 bg-white mb-10 px-3 rounded-md flex justify-between items-start border'>
                                    ...
                                    <div className='flex justify-center items-center gap-3'>
                                        ...
                                        <div className='flex justify-center items-start gap-4 md-lg:hidden'>
                                            <div onClick={() => setStyles('grid')} className={`p-2 ${styles === 'grid' && 'bg-slate-300'} text-slate-600 hover:bg-slate-300 contain-pointer rounded-sm`}>
                                                <BsFillGridFill />
                                            </div>
                                        </div>
                                        <div className='flex justify-center items-start gap-4 md-lg:hidden'>
                                            <div onClick={() => setStyles('list')} className={`p-2 ${styles === 'list' && 'bg-slate-300'} text-slate-600 hover:bg-slate-300 contain-pointer rounded-sm`}>
                                                <FaThList />
                                            </div>
                                        </div>
                                    </div>
